...
public class Quiz extends JFrame{ //ประกาศ class Quiz เป็น public ไปทำงานที่๋JFrame
	...
	RadioQuestion questions[]={ //สร้าง Object ของ class RadioQuestion ชื่อ questions และเก็ข้อมูลแบบ array
		
		new RadioQuestion( //สร้าง Object ของ class RadioQuestion
	...
	public Quiz(){ //ให้method Quiz เป็น Public
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("img\\\\Lol.png")); //setรูปไอคอน(logo)ของเกมส์
		setResizable(true); //กำหนอให้ผู้ใช้ปรับปรับขนาดหน้าเกมส์ได้
		setSize(1200,700); //setหน้าต่างเกมส์ให้มีขนาด 1200*700
